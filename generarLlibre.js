// generarllibre.js - Motor Híbrid V14.3.2 Lec-Flix Policial
// 100% compatible amb main.js V14.3.2 + index.html V14.3.2
...
export async function resetEstructura() {
  ...
  console.log('🔄 Estructura V14.3.2 resetejada');
}
...
async function generaParagraf(config, bancs, hist, numCap, numEsc, totalCaps) {
  ...
  // CABLEJAT 100% AMB MAIN.JS V14.3.2
  ...
  console.log(`✅ Cap${numCap} Esc${numEsc} ${beatActual}: ${paraulesComptades}/${paraulesObjectiu} paraules V14.3.2`);
...
// ========================================
// MOTOR HÍBRID PRINCIPAL - CRIDAT DES DEL MAIN V14.3.2
// ========================================
export async function generarLlibre(config, bancs, hist, numCap, numEsc, totalCaps) {
  hist = blindarHist(hist || histGlobal);

  // CABLEJAT AMB MAIN.JS V14.3.2: config.modo, config.escenesPerCap, config.totalCaps
...
console.log('✅ Motor Híbrid V14.3.2 carregat - escena/capitol/llibre actiu');